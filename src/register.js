...
<input type="radio" className="custom-control-input" id="wantrentproperty1" name="property" value="2" checked/>
<label className="custom-control-label" for="wantrentproperty1">Want Property</label>
</div>
</div>
<div className="col-md-6 mb-20">
<div className="custom-control custom-radio">
<input type="radio" value="3" className="custom-control-input" id="wantrentproperty2" name="property"/>
...
<div className="custom-control custom-radio">
<input type="radio" className="custom-control-input" id="defaultGroupExample4" name="groupOfDefaultRadios1" checked/>
<label className="custom-control-label" for="defaultGroupExample4">Entrepreneur</label>
</div>
</div>
<div className="col-md-4 mb-20 pl-25">
<div className="custom-control custom-radio">
<input type="radio" className="custom-control-input" id="defaultGroupExample5" name="groupOfDefaultRadios1"/>
<label className="custom-control-label" for="defaultGroupExample5">Business Man</label>
</div>
</div>
<div className="col-md-3 mb-20">
<div className="custom-control custom-radio">
<input type="radio" className="custom-control-input" id="defaultGroupExample6" name="groupOfDefaultRadios1"/>
...
<div className="col-md-12 register-radio" id="userregister3" style={{display:"none"}}>
<div className="row">
<div className="col-md-2 mb-20">I am</div>
<div className="col-md-3 mb-20">

<div className="custom-control custom-radio">
<input type="radio" className="custom-control-input" id="defaultGroupExample1" name="groupOfDefaultRadios" checked/>
